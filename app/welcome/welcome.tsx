...
function BrandName() {
  return (
    <span
      className="text-8xl font-extrabold bg-gradient-to-r from-blue-600 via-purple-600 to-indigo-600 bg-clip-text text-transparent antialiased animate-gradient-move"
      style={{
...
function Features() {
  const features = [
    {
      icon: "⚡",
      title: "Instant Configuration Management",
      description: "Update or switch email providers in seconds—no build or redeploy required. Perfect for fast-moving teams."
    },
    {
      icon: "🤝",
      title: "Seamless AWS SES Integration",
      description: "Connect to Amazon SES and other major SMTP providers with zero hassle."
    },
    {
      icon: "👨‍💻",
      title: "Developer-First Experience",
      description: "Modern REST API, SDKs, and a dashboard designed for productivity. Get started in minutes."
    },
    {
      icon: "🏢",
    ...
    >
      <Hero>
        ...
        <h2 className="text-2xl md:text-3xl text-gray-700 mb-6 font-medium animate-fade-in-up animation-delay-200">
          Developer-Friendly Email Sending, Instantly Configurable
        </h2>
        <p className="text-lg text-gray-600 mb-8 max-w-2xl mx-auto leading-relaxed animate-fade-in-up animation-delay-400">
          Email EZ is built for developers: manage email providers and SMTP settings in seconds—no build or redeploy required. Enjoy seamless integration with AWS SES and other major providers, and get started in minutes with our modern, multi-workspace platform.
        </p>
      ...
      <HowItWorks />
      <CTA />
      {/* Scrollbar hiding CSS moved to global styles (e.g., app.css or index.css) */}
    </div>
  );
}