      ...
      <div className="mb-6 relative">
        <div className="bg-gradient-to-r from-slate-50 to-blue-50 rounded-xl border border-slate-200 p-5 shadow-sm">
          <div className="flex items-center gap-2 mb-3">
            ...
            <h4 className="text-sm font-semibold text-slate-700 uppercase tracking-wider" style={{ fontFamily: 'Nunito, sans-serif' }}>
              Configuration ID
            </h4>
          </div>
          <div 
          ...
          >
                ...
                <div className={`flex items-center gap-1 transition-all duration-300 ${
                  ...
                  {copiedId ? (
                    <>
                      ...
                      <span className="text-sm font-medium" style={{ fontFamily: 'Nunito, sans-serif' }}>Copied!</span>
                    </>
                  ) : (
                    <>
                      ...
                      <span className="text-sm font-medium opacity-0 group-hover:opacity-100 transition-opacity duration-200" style={{ fontFamily: 'Nunito, sans-serif' }}>Copy</span>
                    </>
                  )}
                </div>
              </div>
            ...
            <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity duration-200 pointer-events-none">
              <div className="bg-slate-800 text-white px-2 py-1 rounded text-xs font-medium shadow-lg" style={{ fontFamily: 'Nunito, sans-serif' }}>
                Click to copy
              </div>
            </div>
          </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 text-sm">
        <div className="bg-slate-50 rounded-lg p-4 border border-slate-200">
          <div className="flex items-center gap-2 mb-1">
            ...
            <span className="text-slate-600 font-medium" style={{ fontFamily: 'Nunito, sans-serif' }}>From Email</span>
          </div>
        ...
        <div className="bg-slate-50 rounded-lg p-4 border border-slate-200">
          <div className="flex items-center gap-2 mb-1">
            ...
            <span className="text-slate-600 font-medium" style={{ fontFamily: 'Nunito, sans-serif' }}>Username</span>
          </div>
          <span className="text-slate-900 font-mono text-sm break-all" style={{ fontFamily: 'JetBrains Mono, Consolas, monospace' }}>
            {config.username}
          </span>
        ...
        <div className="bg-slate-50 rounded-lg p-4 border border-slate-200">
          <div className="flex items-center gap-2 mb-1">
            ...
            <span className="text-slate-600 font-medium" style={{ fontFamily: 'Nunito, sans-serif' }}>SSL Security</span>
          </div>
